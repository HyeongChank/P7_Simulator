...
# n_data.loc[:,'작업완료시간'] = n_data['작업완료시간'].apply(convert_to_datetime)
# n_data['작업+대기시간'] = n_data['작업완료시간']-n_data['작업생성시간']
# n_data['시간차이_분'] = n_data['시간차이'].dt.total_seconds() / 60
